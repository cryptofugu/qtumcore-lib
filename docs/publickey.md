# Public Key
Represents a BCS public key and is needed to be able to receive BCS, as is usually represented as a BCS [Address](address.md). 

A PublicKey in bcscore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK2 = new bcscore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = bcscore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
